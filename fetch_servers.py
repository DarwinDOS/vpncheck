...
def main():
        ...
        try:
            ...
            if (
                ...
                print(
                    ...
                    f"✓ Загружено {len(servers)} серверов с {url}"
    ...
    if not servers:
        ...
        print(
            ...
            "Все источники недоступны — выход без изменений"
    ...
    print(
        ...
        f"Сохранено в servers.json ({len(servers)} серверов)"
